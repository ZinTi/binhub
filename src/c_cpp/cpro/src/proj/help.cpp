...
void print_env(void){
    ...
    binhub_cprintf(BINHUB_COLOR_INIT(CLR_MAGENTA, CLR_NONE), "gcc -v:"); BINHUB_ENDLINE(1);
    system(CMD_GCC_VERSION);
    binhub_cprintf(BINHUB_COLOR_INIT(CLR_MAGENTA, CLR_NONE), "cmake --version:"); BINHUB_ENDLINE(1);
