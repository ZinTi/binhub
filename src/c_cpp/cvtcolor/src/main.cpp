...
void print_rgb(const RGB* rgb) {
    printf("RGB(");
    binhub_cprintf(BINHUB_COLOR_INIT(CLR_BRT_RED, CLR_NONE), "%3d", binhub_rgb_get_red(rgb));
    printf(", ");
    binhub_cprintf(BINHUB_COLOR_INIT(CLR_BRT_GREEN, CLR_NONE), "%3d", binhub_rgb_get_green(rgb));
    printf(", ");
    binhub_cprintf(BINHUB_COLOR_INIT(CLR_BRT_BLUE, CLR_NONE), "%3d", binhub_rgb_get_blue(rgb));
    printf(")\n");
}