...
#define PROJECT_PATH_1          ";\x25" PROJECT_ENV_VAR "\x25\\bin\\common"
#define PROJECT_PATH_2          ";\x25" PROJECT_ENV_VAR "\x25\\bin\\winnt"
#define PROJECT_PATH_3          ";\x25" PROJECT_ENV_VAR "\x25\\lib"
...
int ConfEnv(char mode){
    char* path[3] = {PROJECT_PATH_1, PROJECT_PATH_2, PROJECT_PATH_3};
    switch(mode){
        case 'i':
        case 'I':
